...
public class MKOICenter extends JPanel {
	...
	public static void reload() {
		...
		ArrayList<String> rotor3List = rotor3.getAlphabetList();
		...
		ArrayList<String> rotor2List = rotor2.getAlphabetList();
		...
		ArrayList<String> rotor1List = rotor1.getAlphabetList();
